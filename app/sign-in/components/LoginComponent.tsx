...
const LoginComponent = () => {
    const setComponent = useAuthComponentSelectionStore((state) => state.setComponent);
  return (
    <motion.div initial={{
        x: 30,
        opacity: 0
      ...
      <div className="flex flex-col gap-5 w-full">
        <CustomTextField name='email' label='Email' placeholder='Enter your email' type="email" />
        <CustomTextField name='password' label='Password' placeholder='Enter your password' type="password" />
      </div>
      <PrimaryButton text='Register' onPressed={() => {}} className='w-full mt-5' />
